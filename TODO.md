...
- [ ] 2025.03.27.18.25 H Check if the PI4B audio device names (`wpctl status --name`) are board dependent.
                         They are currently hardcoded in the `KioskLaunchX11.sh` script generated by `KioskSetup.py`.
...
- [ ] 2025.03.29.22.14 H Update `README.md`, `FAQ.md`, and `GUIDE.md` with the new names of the options in the new "hiearchy".
...
## Completed Tasks
- [ ] 2025.03.29.22.38 H Rename `platform` to `device`.
