...
## Open Tasks
# TODO:
- [ ] 2025.03.27.18.57 H The output device should be user-selectable: HDMI1, HDMI2 or Jack.:
...
- [ ] 2025.03.27.17.48 H Create `cron` job to clear the apt cache regularly: `apt clean`.  The cache's completely superflous.
