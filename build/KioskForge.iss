...
Source: "..\tmp\Template.kiosk"; DestDir: "{app}"; Flags: ignoreversion; Attribs: readonly
...
Root: HKA; Subkey: "Software\Classes\{#MyAppAssocKey}\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" apply ""%1"""
